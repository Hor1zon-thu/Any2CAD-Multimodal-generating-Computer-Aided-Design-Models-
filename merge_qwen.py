...
qwen2_5_coder = AutoModelForCausalLM.from_pretrained(
    "qwen2_5_coder_7b",
    device_map='auto',
    torch_dtype=torch.bfloat16
)
...
# 加载配置
old_config = AutoConfig.from_pretrained("qwen2_5_vl_7b")
new_config = AutoConfig.from_pretrained("multicad") # 新 config 的文件夹路径
